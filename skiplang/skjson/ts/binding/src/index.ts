...
import { Type, type Binding, type CJTyped } from "./binding.js";
import type { Pointer, Nullable } from "../skiplang-std/index.js";
export type { Pointer, Nullable, Binding, CJTyped };
export { Type };
...
export interface TypedConverter<T> {
  import(c: CJTyped, value: Pointer<Internal.CJSON>): T | undefined;
...
export interface JsonConverter<T> {
  ...
  exportJSON(v: JsonObject<T>, type: CJTyped): Pointer<Internal.CJTyped>;
  exportJSON<T extends Internal.CJSON>(
    v: ObjectProxy<T, { [k: string]: Exportable<T> }> & {
      __pointer: Pointer<T>;
    },
  ): Pointer<T>;
  exportJSON(v: Nullable<Json<T>>, type?: CJTyped): Pointer<Internal.CJSON>;
  importOptJSON(
...
export class JsonConverterImpl<T> implements JsonConverter<T> {
  ...
  public is(v: Pointer<Internal.CJSON>, type: Type | CJTyped): boolean {
